...
Current source version: **1.4.0** (`versionCode 18`).
...
- In-reader Tutor notes for selected passages, with clear Chinese explanations and follow-up chat in the same reading view.
